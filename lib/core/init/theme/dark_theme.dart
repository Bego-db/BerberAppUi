...
final ThemeData myDarkTheme = ThemeData(
  ...
  primaryColor: const Color.fromARGB(255, 33, 243, 61),
  primaryColorLight: const Color(0xffbbdefb),
  primaryColorDark: const Color(0xff1976d2),
  useMaterial3: true,
  canvasColor: const Color(0xfffafafa),
  scaffoldBackgroundColor: const Color(0xff050505), // Scaffold backround
  cardColor: const Color(0xff000000), //X bekleyen randevular
  dividerColor: const Color(0x1f000000),
  highlightColor: const Color(0xffA09FA8), //"tümünü gör" text color
  splashColor: const Color(0x66c8c8c8),
  unselectedWidgetColor:
      const Color(0xffCAE65A), //yaklaşan randevular backround
